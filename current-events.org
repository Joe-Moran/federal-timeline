...
:END:
- Note taken on [2025-04-29 Tue 20:22] \\
...
:END:
**** Trump states in an interview with ABC that he could order Garcia home but his lawyers don't want him to :Trump:contempt:unconstitutional:interview:immigration:deporation:CECOT:
:PROPERTIES:
...
**** DOJ is denied another request for a stay on discovery in Garcia case :requestForStay:DOJ:contempt:
:PROPERTIES:
